...
SCENARIOS = [
    ...
    # --- Social ---
    {
        ...
        "formality_min": 2,
        "formality_max": 4,
        "style_notes": "Wear something that makes YOU feel good — confidence shows. Slightly elevated from your everyday look. Avoid brand-new clothes you haven't worn before — comfort matters. Choose colours that complement your skin tone.",
    },
    {
        ...
        "formality_min": 3,
        "formality_max": 4,
        "style_notes": "Conservative but not stuffy. Clean, well-fitted basics. No graphic tees, ripped jeans, or flashy logos. Think 'Sunday lunch at a nice pub' — smart-casual, warm, approachable.",
    },
    {
        "name": "House Party",
        "description": "Express yourself. More relaxed but still show you put thought into it.",
        "icon": "🎉",
        "category": "social",
        "formality_min": 1,
        "formality_max": 3,
        "style_notes": "Casual with personality. This is where you can experiment — interesting textures, bolder colours, statement pieces. Comfort matters because you'll be standing and moving. Layers work well as houses vary in temperature.",
    },
    {
        "name": "Brunch with Friends",
        "description": "Effortlessly cool. Relaxed but curated — like you woke up looking this good.",
        "icon": "☕",
        "category": "social",
        "formality_min": 1,
        "formality_max": 2,
        "style_notes": "Casual, clean, laid-back. Think well-fitting jeans, a quality tee or light knit, clean trainers. Accessorise simply — sunglasses, a nice watch. The vibe is 'I didn't try hard but I look great'.",
    },

    # --- Formal ---
    {
        "name": "Wedding Guest",
        "description": "Celebrate the couple. Dress for the venue and time of day — never upstage the wedding party.",
        "icon": "💒",
        "category": "formal",
        "formality_min": 4,
        "formality_max": 5,
    ...
    {
        "name": "Travel Day",
        "description": "Comfort is king but you'll be photographed at the airport and arrive somewhere new.",
        "icon": "✈️",
        "category": "casual",
        "formality_min": 1,
        "formality_max": 2,
